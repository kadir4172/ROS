...
if("FALSE" STREQUAL "TRUE")
  set(a3_help_SOURCE_PREFIX /home/kadir/Desktop/Freelancer/Project4_ROS/ROS/catkin_ws/src/a3_help)
  set(a3_help_DEVEL_PREFIX /home/kadir/Desktop/Freelancer/Project4_ROS/ROS/catkin_ws/devel)
  set(a3_help_INSTALL_PREFIX "")
  set(a3_help_PREFIX ${a3_help_DEVEL_PREFIX})
else()
  set(a3_help_SOURCE_PREFIX "")
  set(a3_help_DEVEL_PREFIX "")
  set(a3_help_INSTALL_PREFIX /home/kadir/Desktop/Freelancer/Project4_ROS/ROS/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'a3_help' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kadir/Desktop/Freelancer/Project4_ROS/ROS/catkin_ws/install/${idir}'.  Ask the maintainer 'student <student@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kadir/Desktop/Freelancer/Project4_ROS/ROS/catkin_ws/install/lib;/home/kadir/Desktop/Freelancer/Project4_ROS/ROS/catkin_ws/devel/lib;/home/kadir/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(a3_help_EXPORTED_TARGETS "a3_help_generate_messages_cpp;a3_help_generate_messages_eus;a3_help_generate_messages_lisp;a3_help_generate_messages_nodejs;a3_help_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${a3_help_dep}_FOUND)
      find_package(${a3_help_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${a3_help_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
