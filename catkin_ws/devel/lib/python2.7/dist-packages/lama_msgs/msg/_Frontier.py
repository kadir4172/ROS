...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_6d2f().pack(_x.p1.x, _x.p1.y, _x.p1.z, _x.p2.x, _x.p2.y, _x.p2.z, _x.width, _x.angle))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.p1.x, _x.p1.y, _x.p1.z, _x.p2.x, _x.p2.y, _x.p2.z, _x.width, _x.angle,) = _get_struct_6d2f().unpack(str[start:end])
      return self
