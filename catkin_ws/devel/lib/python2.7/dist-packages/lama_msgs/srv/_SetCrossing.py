...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3d2f().pack(_x.descriptor.center.x, _x.descriptor.center.y, _x.descriptor.center.z, _x.descriptor.radius, _x.descriptor.max_range))
      ...
      for val1 in self.descriptor.frontiers:
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _x = val1
        buff.write(_get_struct_2f().pack(_x.width, _x.angle))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.descriptor.center.x, _x.descriptor.center.y, _x.descriptor.center.z, _x.descriptor.radius, _x.descriptor.max_range,) = _get_struct_3d2f().unpack(str[start:end])
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        (_x.width, _x.angle,) = _get_struct_2f().unpack(str[start:end])
