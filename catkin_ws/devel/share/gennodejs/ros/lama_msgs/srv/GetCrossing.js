...
class GetCrossingRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCrossingRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCrossingRequest
    let len;
    let data = new GetCrossingRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCrossingRequest(null);
    if (msg.id !== undefined) {
      resolved.id = msg.id;
    }
    else {
...
class GetCrossingResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCrossingResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCrossingResponse
    let len;
    let data = new GetCrossingResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCrossingResponse(null);
...
module.exports = {
  Request: GetCrossingRequest,
  Response: GetCrossingResponse,
  md5sum() { return '4842af2f1edf5a2e9caf0cee19515bcc'; },
  datatype() { return 'lama_msgs/GetCrossing'; }
};
